...
const CONFIG_DIR = process.env.CS_PLUGIN_CONFIG_DIRECTORY || `${process.env.HOME || '/root'}/.containership/config`;
const CLI_CONFIG_FILE = process.env.CS_CLI_CONFIG_FILE || 'cli-v2.json';
...
class ContainershipPlugin {
    ...
    loadConfigSync() {
        ...
        const cliConfig = this.safeParse(this.safeRead(`${CONFIG_DIR}/${CLI_CONFIG_FILE}`));
